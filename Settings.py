...
def Load_graphig_settings():
    ...
    Text_größe_anpassen = Class_gen.Text_scalierung(command_=Load_settings.Load_text_size, x_pos=10, y_pos=10+4*int(text_size), Anzeige_ort=Graphig_bildschirm, aktuelle_zahl=int(text_size), font_=Textgröße_von_alle_Texte, size=int(text_size))
