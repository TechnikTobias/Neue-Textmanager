...
def weiter_vers():
    ablauf_varables[2] += 1
    if ablauf_varables[2] >=1 and ablauf_varables [2] < alle_inhalt[ablauf_varables[1]][1][3]:
        print(alle_inhalt[ablauf_varables[1]][1][3])
    ablauf_akualisieren()
...
def ablauf_akualisieren():
    print(alle_inhalt[ablauf_varables[1]][1][1])
